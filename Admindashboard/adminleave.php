...
<html lang="en">
  ...
  <div class="top-nav notification-row">                
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-table"></i> Admin Leave</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="index.html">Home</a></li>
						<li><i class="fa fa-table"></i>Leave Requests</li>
						<li><i class="fa fa-th-list"></i>Leave Requests</li>
					</ol>
				</div>
			</div>
              <!-- page start-->
...
if ($result->num_rows > 0) {
	...
	{   
		...
		<input type='submit' name='check' value='Approve' /></td><td><input type='submit' name='check' value='Disapprove' /></td>
								  </td>                                                                  
								</tr>
								</form>
								";
